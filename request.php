				...
				<section id="banner">
					...
					<section style="text-align: center; margin-center: 50px">
						...
						<form method="post" action="logincheck.php" style="margin-top: 3em; width: 30%; padding-bottom: 2em;">
							<div>
								<div>
									<input style="background-color: rgba(200,200,200,0.6);color: rgba(38,38,38,1);font-weight: bold !important; width=30%" type="text" placeholder="Request" name="request" required />
								</div>
