		    ...
		    <h2>Hospital Management</h2>
				<p>Employee Login</p>
					<center>
						...
						<form method="post" action="logincheck1.php" style="margin-top: 8em; width: 50%; padding-bottom: 2em;">
							<div class="row uniform 50%">
								<div class="6u 12u(mobilep)">
									<input style="background-color: rgba(200,200,200,0.6);color: rgba(38,38,38,1);font-weight: bold !important; width=50%" type="text" placeholder="Username" name="username" required />
								</div>
								<div class="6u 12u(mobilep)">
							...
							<div class="row uniform 50%">
								<div class="12u">
									<ul class="actions">
										<li>
											<input style="height: 3em;" tabindex="-1" type="submit" name="login" value="Login" />
										</li>
									</ul>
								</div>
							</div>
